...
import { downloadBundle, downloadGeneratedFile, downloadProject, downloadText } from '../core/export';
...
export function FileWorkspace({ project, bundle, agent, notify }: Props) {
  ...
  function exportZip() {
    try { downloadBundle(project, bundle); notify('Project ZIP downloaded.'); }
    catch (error) { notify(error instanceof Error ? error.message : 'Export failed. Try again.'); }
  }
